...
<div class="navbar navbar-inverse navbar-fixed-top">
  <div class="container" style="margin: 0%">
    <div class="navbar-header">
      ...
      <a class="navbar-brand hidden-sm" href="/" onclick="_hmt.push(['_trackEvent', 'navbar', 'click', 'navbar-首页'])">登录</a></div>
    </div>
  </div>
</div>

<div class="container" style="margin-top: 50px"  >
  <form class="form-signin" style="width: 300px" action="/welcome/register">
    ...
    <button class="btn btn-success" type="submit" style="width: 300px">注册</button>
  </form>
</div>
